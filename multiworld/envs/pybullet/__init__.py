...
def register_pybullet_envs():
    ...
    register(
        id='Jaco2ObjectsPusherOneXYSimpleEnv-v0',
    ...
    register(  # just for gym goal env
        id='Jaco2PushPrimitiveOneXYGoalEnv-v0',
        entry_point='multiworld.envs.pybullet.jaco_push_primitive.jaco_push_primitive:Jaco2PushPrimitiveXYGoalEnv',
    ...
    register(  # just for gym goal env
        id='Jaco2PushPrimitiveOneXYGoalAddDistEnv-v0',
        entry_point='multiworld.envs.pybullet.jaco_push_primitive.jaco_push_primitive:Jaco2PushPrimitiveXYGoalAddDistEnv',
        max_episode_steps=10,
        reward_threshold=20000.0,
        kwargs=dict(
            # env arguments
...
###  Disc
register(
        id='Jaco2PushPrimitiveDiscOneXYEnv-v0',
        entry_point='multiworld.envs.pybullet.jaco_push_primitive.jaco_push_primitive_disc:Jaco2PushPrimitiveXYDisc',
        ...
        kwargs=dict(
            ...
            obj_name_list=['b_cube_m', 'b_cube_w', 'b_L1', 'b_L2',
                           'b_cube_m', 'b_cube_w', 'b_L1', 'b_L2'],
            num_movable_bodies=1,
            obj_pos_upper_space=(0 + 0.16, -0.24, 0.06),
            obj_pos_lower_space=(0 - 0.16, -0.56, 0.06),
            obj_max_upper_space=(0 + 0.18, -0.22, 0.4),
            obj_max_lower_space=(0 - 0.18, -0.58, -0.4),
            ...
            # robot params
            random_robot_ee_pos=False,
            hand_init_upper_space=(0 + 0.2, -0.2, 0.154),
            hand_init_lower_space=(0 - 0.2, -0.6, 0.154),
            ...
            # base arguments
            kinova_type='j2s7s300_beam',
            control_mode='push_primitive_discXY',
            ...
            # kinova arguments
            isLimitedWorkSpace=True,
            hand_high=(0 + 0.3, -0.15, 0.4),
            hand_low=(0 - 0.3, -0.7, -0.4),
            useDynamics=True,
